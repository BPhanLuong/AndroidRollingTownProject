...
public class GallerieActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Log.i("GallerieAdapter adapter", "myImageList.size() :"+myImageList.size());
		GallerieAdapter adapter = new GallerieAdapter(this, myImageList);
		
		myGridView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
		
		myGridView.setTextFilterEnabled(true);
		myGridView.setOnItemClickListener(new OnItemClickListener() {
	    	...
	    	public void onItemClick(AdapterView<?> parent, View view, int position, long id){
	    		...
	    		Intent i = new Intent(GallerieActivity.this, OnePhotoActivity.class);
	    		

	    		try {
	    			//Log.i("GallerieActivity OnePhoto", myJSONObjectImageList.get(position).get("path").toString());
	...
	public void onClick(View v) {
		if (v.getId() == R.id.button1){
    		Intent i = new Intent(GallerieActivity.this, PhotoAdapterActivity.class);    		
